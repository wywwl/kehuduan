                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link active" href="http://www.zuidaima.com/share/p1-s1.htm">时间</a></li>
                                <li class="nav-item"><a class="nav-link" href="http://www.zuidaima.com/share/p1-s2.htm">下载</a></li>
                                <li class="nav-item"><a class="nav-link" href="http://www.zuidaima.com/share/p1-s3.htm">评论</a></li>
                                <li class="nav-item"><a class="nav-link" href="http://www.zuidaima.com/share/p1-s4.htm">牛币</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-3 right_bar">
            ...
            <div class="user">
                <div class="name">${li.name}
                    &nbsp;<span title="2级,距离下次升级还差2贡献值" class="lv_sub">LV${li.grade}</span>
                </div>
                <div class="row margin_top10">
                    ...
                    <div class="col-6">
                        ...
                        <p>牛币:${li.nbcount}</p>
                        <p>
                            <a title="贡献值10,距离下次升级还差2贡献值" href="/faq.htm#rank_rule" target="_blank" rel="nofollow">
                                <img class="lv" alt="星星" src="http://static.zuidaima.com/resource/img/lv_star.png">
                                <img class="lv" alt="星星" src="http://static.zuidaima.com/resource/img/lv_star.png">
                            </a>
                        </p>
                    </div>
                ...
                <div class="margin_top10">简介：</div>
                <div class="margin_top10">注册时间：${li.createtime}</div>
                <div class="margin_top10">最近登录：${li.lastlogintime}</div>
            </div>
            <table class="table table-bordered margin_top10 margin_bottom10">
                <tbody>
                <tr>
                    <td width="50%">
                        <a href="/user/4058730828728320/share.htm">${codecount}<br>代码</a>
                    </td>
                    <td>
                        <a href="/user/4058730828728320/question.htm">${problemcount}<br>问题</a>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="50%">
                        <a href="/user/4058730828728320/blog.htm">${blogcount}<br>博客</a>
                    </td>
                </tr>
                </tbody>
            </table>
