...
<head>
    ...
    <title>${user.login}的个人资料--${applicationScope.bbsinfo.name}</title>
    <meta name="keywords" content="${user.login}的个人资料" />
    <meta name="description" content="${user.login}的个人资料" />
...
<%@ include file="/WEB-INF/inc/xinxi-top.jsp"%>
                    ...
                    <div class="u_profile qing_u_profile">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li><em class="xg1">管理组&nbsp;&nbsp;</em><span style="color:#00CC00"><a href="javascript:;" ><font color="#00CC00">${user.groupname}</font></a></span> </li>
