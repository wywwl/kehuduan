...
<!-- 引入fileinput的css -->
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath() %>/bootstrap-fileinput-master/css/fileinput-rtl.min.css" />


<!-- 引入ckplayer -->
<script type="text/javascript" src="<%=request.getContextPath() %>/ckplayer/ckplayer/ckplayer.js"></script>
<!-- 引入jquery -->
...
<!--  引入fileinput的js -->
<script type="text/javascript" src="<%=request.getContextPath()%>/bootstrap-fileinput-master/js/plugins/piexif.js"></script>
<!--  引入fileinput的js -->
<script type="text/javascript" src="<%=request.getContextPath()%>/bootstrap-fileinput-master/js/plugins/purify.min.js"></script>

<!--  引入fileinput的js -->
<script type="text/javascript" src="<%=request.getContextPath()%>/bootstrap-fileinput-master/js/plugins/sortable.min.js"></script>
