        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse nav_wrap">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <div id="search_box">
                            <input type="text" id="search" placeholder="搜索您要的代码" value="搜索您要的代码" id="aa"/>
                            <a href="javascript:sercher()" class="icon-search fa fa-search"></a>
                        </div></li>
                </ul>
            </div>
...
<div class="main container margin_top10 width_998">
    ...
    <div class="row">
        <div class="col-9 left_bar">
            ...
            <div class="data row">
                <div class="col-1">
                    <a class="name" href="/user/2682953842198528.htm"><img content_id="2682953842198528_0" alt="zdd123456的gravatar头像" class="profile rounded-circle" src="http://static.zuidaima.com//resource/img/default_avatar.png" /></a>
                </div>
                <div class="col-11">
