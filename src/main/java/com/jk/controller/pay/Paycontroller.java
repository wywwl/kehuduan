...
public class Paycontroller {
    ...
    @ResponseBody
    public String goAlipay(UserBean str,Integer id, Integer jiaqian, HttpServletRequest request, HttpServletRequest response) throws Exception {
    ...
    @ResponseBody
    public void addusernb(Integer nbcount,Integer id){


        payService.updatecoun(nbcount,id);
    }
