...
public class OSSClientUtil {
    ...
    protected static String accessKeyId  = "LTAIbR4dhD9oiZjs";
    protected static String accessKeySecret  = "rFM2iRibucjjIVtIoubSs7w0RUmWDT";
    protected static String bucketName  = "jinke1804a";
    //文件存储目录
    private String filedir = "1804/";
